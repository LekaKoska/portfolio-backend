    ...
    <div class="flex flex-col">
        ...
        <div class="rounded-2xl border border-slate-200 bg-slate-50 p-4 flex flex-col gap-4">
            ...
            <div class="flex gap-2 items-center">
                <input type="text" placeholder="Ask about Alek..." id="chat-input" class="flex-1 rounded-2xl border border-slate-200 bg-white px-4 py-3 text-sm text-slate-800 placeholder:text-slate-400 outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-400/50 transition">
